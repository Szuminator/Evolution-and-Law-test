...
const QUIZZES = {
  ...
  evo: {
    ...
    questions: [
      ...
      { q: "Dlaczego w wyniku doboru płciowego u samców często wykształcają się cechy, które mogą utrudniać przetrwanie (np. wielki ogon pawia)? ", options: ["Ponieważ cechy te zwiększają sukces w rywalizacji o partnerkę lub atrakcyjność dla samic, co przeważa nad kosztem przeżycia.", "Ponieważ są to cechy atawistyczne, które nie zostały jeszcze wyeliminowane przez dobór naturalny.", "Ponieważ dobór płciowy działa w kierunku przeciwnym do ewolucji, osłabiając gatunek.", "Ponieważ drapieżniki instynktownie unikają ofiar o jaskrawych barwach i dużych ozdobach."], correct: 0 },
      { q: "Zgodnie z teorią dostosowania łącznego (inclusive fitness) i regułą Hamiltona, altruizm ewoluuje najłatwiej, gdy: ", options: ["Pomoc jest udzielana osobnikom niespokrewnionym, którzy mogą się w przyszłości odwdzięczyć.", "Koszt ponoszony przez altruistę jest wysoki, a zysk biorcy niski.", "Osobnik pomagający jest blisko spokrewniony z osobnikiem otrzymującym pomoc (wspólne geny).", "Działanie to przynosi korzyść całemu gatunkowi, niezależnie od pokrewieństwa."], correct: 2 },
      ...
      { q: "12.	Koncepcja „zegara molekularnego” wykorzystywana w filogenetyce zakłada, że: ", options: ["Wszystkie zmiany ewolucyjne zachodzą w skokach co określony czas.", "Niektóre mutacje (głównie neutralne) akumulują się w sekwencjach DNA w stałym tempie w czasie.", "Tempo ewolucji zależy wyłącznie od zmian temperatury na Ziemi.", "Organizmy bardziej złożone ewoluują szybciej niż proste."], correct: 1 },
